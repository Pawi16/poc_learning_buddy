...
def build_type_instructions(question_types: List[str], difficulty: str) -> str:
    ...
    if difficulty.lower() == "easy":
        ...
        distractors = "Distractors should be obviously incorrect."  # <--- RESTORED
        ...
        distractors = "Distractors should be plausible but clearly wrong to a careful reader." # <--- RESTORED
        ...
        distractors = "Distractors must be highly plausible common misconceptions." # <--- RESTORED
    ...
    request_data = {
      ...
      "quiz_config": [
        ...
        },
        {
          "difficulty": "hard",
          "quiz_type_config": [
            { "type": "statement_counting", "number": 3 }
          ]
        }
      ]
    }
